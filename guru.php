    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-warning fixed-top">
      ...
      <div class="row no-gutters mt-5">
        ...
        <div class="col-md-10 p-5 pt-2">
            <h3><i class="fa-solid fa-chalkboard-user mr-2"></i> DAFTAR GURU</h3><hr>

            <a href="tambah_guru.php" class="btn btn-primary mb-3"><i class="fa-solid fa-user-plus mr-2"></i>TAMBAH DATA GURU</a>
                ...
                <?php
                      ...
                      while($hasil= mysqli_fetch_array($data)) {
                        ...
                        <tr>
                          ...
                          <td><?php echo $hasil['kehadiran_id_kehadiran']; ?></td>
